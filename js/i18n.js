...
(function () {
  ...
  const DICT = {
    ru: {
      ...
      nav_valves: "Запорно-регулирующая арматура",
      nav_internals: "ВКУ",
      ...
      home_lead: "Запорно-регулирующая арматура, средства измерений, внутренние контактные устройства.",
      ...
      home_cv: "Клапаны регулирующие",
      home_pr: "Регуляторы давления",
      home_si: "Средства измерений",
      home_valves: "Запорно-регулирующая арматура",
      home_valves_p: "Регулирующая и запорная арматура для технологических трубопроводов.",
      home_vku: "Внутренние контактные устройства",
      about_eyebrow: "О компании",
      about_h2: "ООО «АКМАН»",
      about_p: "Поставляем запорно-регулирующую арматуру, средства измерений и внутренние контактные устройства для объектов нефтегазохимической отрасли. Официальный дистрибьютор зарубежных производителей в РФ и странах Таможенного союза.",
      ...
      opt_valves: "Запорно-регулирующая арматура",
      ...
      files_hint: "Можно выбрать несколько файлов или целую папку (опросный лист, ТЗ, чертежи). Суммарно до 10 МБ.",
      ...
      company_p1: "ООО «АКМАН» поставляет технологическое оборудование для нефтегазохимической отрасли: запорно-регулирующую арматуру, средства измерений и внутренние контактные устройства колонного оборудования.",
      ...
      products_valves: "Запорно-регулирующая арматура",
    ...
    en: {
      ...
      nav_valves: "Shut-off and control valves",
      ...
      home_lead: "Shut-off and control valves, measuring instruments, tower internals.",
      ...
      home_cv: "Control valves",
      home_pr: "Pressure regulators",
      home_si: "Measuring instruments",
      home_valves: "Shut-off and control valves",
      home_valves_p: "Control and shut-off valves for process pipelines.",
      home_vku: "Tower internals",
      about_eyebrow: "About",
      about_h2: "AKMAN LLC",
      about_p: "We supply shut-off and control valves, measuring instruments and tower internals for oil, gas and petrochemical facilities. Official distributor of foreign manufacturers in Russia and the Customs Union.",
      ...
      opt_valves: "Shut-off and control valves",
      ...
      files_hint: "You can attach multiple files or a whole folder (questionnaire, specs, drawings). Total up to 10 MB.",
      ...
      company_p1: "AKMAN LLC supplies process equipment for the oil, gas and petrochemical industry: shut-off and control valves, measuring instruments, and column internals.",
      ...
      products_valves: "Shut-off and control valves",
