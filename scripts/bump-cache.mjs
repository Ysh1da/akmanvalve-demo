...
for (const rel of files) {
  ...
  const next = html
    ...
    .replace(/main\.js\?v=\d+/g, "main.js?v=29")
    .replace(/phrases\.js\?v=\d+/g, "phrases.js?v=29")
    .replace(/i18n\.js(\?v=\d+)?/g, "i18n.js?v=29")
    .replace(/search\.js\?v=\d+/g, "search.js?v=29")
    .replace(/lightbox\.js(\?v=\d+)?/g, "lightbox.js?v=29");
